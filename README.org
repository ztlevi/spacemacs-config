...
*** Configuration and Dependencies
    This Emacs configuration is written for Emacs 25.1+ on MacOS 10.11+ and Linux Arch. Windows users may need to tweak the config for themselves.
    ...
    4. Dependencies needed
       ...
       #+END_SRC
    5. Emacs2Ram(Optional): Put the .emacs.d in the tempfs. Working on Linux and Mac. Link over [[http://blog.binchen.org/posts/emacs-speed-up-1000.html][here]].
       - Step 1: insert below line into /etc/fstab and restart computer:
         #+BEGIN_SRC shell
         tmpfs       /tmp        tmpfs       nodev,nosuid,size=8G    0   0
         #+END_SRC
       - Step 2: run ~./emacs2ram.sh start~
       Notes: Reboot needs to do the cron job. Or you can add a startup script to your system.
