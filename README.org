...
*** Configuration and Dependencies
    ...
    3. Install Dejavu fonts for Unicode. The fonts can be found under at [[http://sourceforge.net/projects/dejavu/files/dejavu/2.35/dejavu-fonts-ttf-2.35.tar.bz2][here]].
