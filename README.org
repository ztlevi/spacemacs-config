...
*** Step3: Configuration and Dependencies
    ...
    1. Clone my configuration:
       ...
       #+END_SRC
    2. Install all-the-icons fonts by ~M-x all-the-icons-install-fonts~ and [[https://github.com/sebastiencs/icons-in-terminal/blob/master/build/icons-in-terminal.ttf][icons-in-terminal]]. I'm using /Operator Mono Lig/ font(supports ligatures), you could change it under ~dotspacemacs-default-font~.
